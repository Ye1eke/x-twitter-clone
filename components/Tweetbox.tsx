...
function Tweetbox({ setTweets }: Props) {
  ...
  return (
    <div className='flex space-x-2 p-5 border-b border-zinc-800'>
      <img 
      ...
      <div className='flex flex-1 items-center pl-2'>
        <form className='flex flex-1 flex-col'>
            <input
                ...
                type='text' placeholder="What is happening?!" className='h-24 w-full text-xl outline-none placeholder:text-xl bg-black'/>
            <div className='flex items-center border-t border-zinc-800 pt-2'>
                ...
                <button 
                    ...
                    className='bg-twitter px-5 py-2 font-bold text-white rounded-full disabled:opacity-40'>Post</button>
            </div>
            {imageUrlBoxIsOpen && (
            ...
            {image && (
              <img 
                className='mt-10 h-40 w-full rounded-xl object-contain ring-1 ring-zinc-800'
                src={image} alt="" />
            )}
        </form>
      </div>
